                ...
                <div class="flex flex-wrap -m-3">
                        ...
                        <div class="p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard">
                            ...
                            <div class="flex flex-wrap items-center justify-between -m-1">
                                <div class="w-auto p-1">
                                    <h2 class="font-medium text-3xl text-black tracking-tighter">62</h2>
                                </div>
                                <div class="w-auto p-1">
                                    <div class="flex items-center px-2 py-1 text-green-500 font-medium text-xs bg-green-100 rounded-full shadow-sm">
                    ...
                    <div class="w-full md:w-1/3 p-3">
                        <div class="p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard">
                            <div class="flex flex-wrap items-end justify-between -m-2 mb-2">
                                <div class="w-auto p-2">
                                    <h3 class="text-sm text-coolGray-500 font-medium">Total Reviews</h3>
                                </div>
                                <div class="w-auto p-2">
                                    <a href="#">
                                        <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex flex-wrap items-center justify-between -m-1">
                                <div class="w-auto p-1">
                                    <h2 class="font-medium text-3xl text-black tracking-tighter">14</h2>
                                </div>
                                <div class="w-auto p-1">
                                    <div class="flex items-center px-2 py-1 text-green-500 font-medium text-xs bg-green-100 rounded-full shadow-sm">
                                        <svg width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="w-full md:w-1/3 p-3">
                        <div class="p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard">
                            <div class="flex flex-wrap items-end justify-between -m-2 mb-2">
                                <div class="w-auto p-2">
                                    <h3 class="text-sm text-coolGray-500 font-medium">Total Rejections</h3>
                                </div>
                                <div class="w-auto p-2">
                                    <a href="#">
                                        <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex flex-wrap items-center justify-between -m-1">
                                <div class="w-auto p-1">
                                    <h2 class="font-medium text-3xl text-black tracking-tighter">30</h2>
                                </div>
                                <div class="w-auto p-1">
                                    <div class="flex items-center px-2 py-1 text-green-500 font-medium text-xs bg-green-100 rounded-full shadow-sm">
                                        <svg width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
