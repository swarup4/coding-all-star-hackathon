                ...
                <div className="p-6 bg-white rounded-md shadow-lg">
                    <div className="flex flex-wrap items-center justify-between -mx-2">
                        <div className="w-auto px-2">
                            <h2 className="text-lg text-coolGray-900 font-semibold">Top Ranker</h2>
                            <p className="text-xs text-coolGray-500 font-medium">Card heading subtitle</p>
                        </div>
                        <div className="w-auto px-2">
                            <a href="#">
                    ...
                    <div className="pt-6 mt-6 border-t border-coolGray-100">
                        <section className="bg-coolGray-50 py-4">
                            <div className="container px-4 mx-auto">
                                                ...
                                                <div className="w-full lg:w-auto p-2">
                                                    <div className="flex flex-wrap items-center -m-2">
                                                        ...
                                                        <div className="w-auto p-2">
                                                            ...
                                                            <h3 className="text-xs font-medium text-coolGray-400">UI/UX Designer</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="w-full lg:w-auto p-2">
                                            ...
                                            <div className="flex flex-wrap px-4 py-6 border-b border-coolGray-100 -m-2">
                                                ...
                                                <div className="w-full md:w-1/2 lg:w-1/4 p-2">
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-xs text-coolGray-400 font-medium">Approved</p>
                                                    </div>
                                                </div>
                                                <div className="w-full md:w-1/2 lg:w-1/4 p-2">
                                                    <div className="text-center">
                                                ...
                                                <div className="w-full md:w-1/2 lg:w-1/4 p-2">
                                                    <div className="text-center">
                                                        <p className="mb-1 text-xs text-coolGray-900 font-semibold">2</p>
                                                        <p className="text-xs text-coolGray-400 font-medium">Points</p>
                                                    </div>
                                                </div>
                                            </div>
