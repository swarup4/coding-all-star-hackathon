    ...
    return (
        <>
            <section className="bg-white">
                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        <div className="hidden xl:block xl:w-1/3">
                            <ul className="flex justify-center">
                                ...
                                <li className="mr-12"><Link to='/dashboard/review' className="text-coolGray-500 hover:text-coolGray-900 font-medium">Review</Link></li>
                            </ul>
                        </div>
                        <div className="hidden xl:block xl:w-1/3">
                ...
                <div className="navbar-menu hidden fixed top-0 left-0 z-40 w-full h-full bg-coolGray-900 bg-opacity-50">
