                        ...
                        <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-4 mb-10" key={ind}>
                            <div className="text-center max-w-xs mx-auto">
                                {res.profilePics ? (
                                    ...
                                    <div className={`flex items-center justify-center w-20 h-20 text-base font-medium rounded-full text-yellow-600 bg-yellow-200`}>{getInitial(res.name)}</div>
                                )}
                                    ...
                                    {res.social ? (
                                        <>
                                            {res.social.socialMedia.map((x, ind) => (
                                                <>
                                                    {x.name == 'facebook' ? (
                                                        <a className="inline-block mr-4 hover:opacity-80" href={x.url} target='_blank'>
                                                    ...
                                                    {x.name == 'instagram' ? (
                                                        <a className="inline-block hover:opacity-80" href={x.url} target='_blank'>
